 ...
 * 法改正ガイドページ
 *
 * 改正区分所有法（2026年4月施行）の3つのポイントを解説し、
 * FAQ アコーディオンで補足情報を提供する。
 *
 * AuthGuard でラップ不要 — ガイドは誰でも閲覧可能。
 * "use client" は AppHeader が Client Component のため必要。
 */
...
また、令和7年（2025年10月）に国交省が標準管理規約を全面改正しており、置き配ルール、EV充電設備、電子議決権など、現代のマンション生活に必要なルールの見本が示されています。`,
  },
  {
    ...
    answer: `**おすすめは「2026年4月以降の通常総会」で改正すること**です。
