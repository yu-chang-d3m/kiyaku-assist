 ...
 * ログインページ
 *
 * Firebase Auth によるメール/パスワード認証と Google ログインを提供する。
 * Firebase 未設定時はデモモードへの遷移ボタンを表示する。
 *
 * v1 からの改善:
 * - import パスを @/shared/auth/auth-context に統一
...
export default function LoginPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 flex items-center justify-center px-4 bg-muted/30">
